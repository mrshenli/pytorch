...
def add_torch_libs():
    ...
    libtorch_python_sources = [
        ...
        "torch/csrc/distributed/rpc/Request.cpp",
        "torch/csrc/distributed/rpc/Response.cpp",
        "torch/csrc/distributed/rpc/Client.cpp",
        "torch/csrc/distributed/rpc/Server.cpp",
        "torch/csrc/distributed/rpc/ProcessGroupTransport.cpp",
